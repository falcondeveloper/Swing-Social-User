...
export default function PostDetail(props: { params: Params }) {
  ...
  const handleGetPostComments = async () => {
    try {
      const response = await fetch(
        "/api/user/whatshot/post/comment?&postId=" + id
      );
      const data = await response.json();
                    ...
                    <Box sx={{ display: "flex", gap: 2 }}>
                      ...
                      <Box sx={{ flex: 1 }}>
                        ...
                        <Box
                          sx={{
                            display: "flex",
                            gap: `${isMobile === true ? "2px" : "8px"}`,
                            mt: `${isMobile === true ? "10px" : "2"}`,
                            ml: `${isMobile === true ? "-60px" : "20"}`,
                            mb: 1,
                          }}
                        >
                          <Button
                          ...
                          {profileUsername === comment.Username && (
                            <>
                              ...
                              <Button
                                ...
                                startIcon={<Delete />}
                                onClick={() =>
                                  handleDeleteComment(comment.CommentId, id)
                                }
                                sx={{
                                  color: "#f50057",
                                  "&:hover": { bgcolor: "rgba(245,0,87,0.08)" },
