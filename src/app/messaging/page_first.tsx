...
import { Send as SendIcon, EmojiEmotions as EmojiIcon, Image as ImageIcon, Delete, ArrowBack } from "@mui/icons-material";
            ...
            >
                ...
                {isMobile ?
                    <Box sx={{ display: "flex", flexDirection: "column", height: "calc(100vh - 150px)", width: "100%", backgroundColor: "#2d2d2d", mt: 10 }}>
                        ...
                        {/* <Box sx={{ display: "flex", alignItems: "center", padding: "25px", gap: 1, background: '#000' }}>
                            <TextField
                                fullWidth
                                variant="outlined"
                                placeholder="Search..."
                                ...
                                InputProps={{
                                    sx: { backgroundColor: "#2d2d2d", color: "white", borderRadius: "8px" },
                                }}
                            />
                            <Button variant="contained" sx={{ backgroundColor: "#2d2d2d", color: "white", minWidth: "48px", padding: "15px 17px", background: "#ff1b6b" }}>
                                <SearchIcon />
                            </Button>
                        </Box> */}
                            ...
                            {activeTab === 0 ? (
                                <>
                                    <Button
                                        ...
                                        variant="contained"
                                        sx={{ backgroundColor: "#FF1B6B", mt: 2, padding: 2 }}
                                        fullWidth
                                    >
                                        Create Chat
                                    </Button>
                                        ...
                                        {chatList.map((chat: any, index: number) => {
                                            ...
                                            return (
                                                <ListItem
                                                    ...
                                                    onClick={() => router.push(`/messaging/${chat?.ToProfileId}`)} // Redirect when clicking anywhere except the delete button
                                                >
                                                    {/* Avatar */}
                                                    <ListItemAvatar>
                                                        <Badge
                                                    ...
                                                    <ListItemText
                                                        ...
                                                        secondary={hasImage ? "Sent an Image" : chat.Conversation || "No message yet"} // Show "Sent an Image" if image is detected
                                                        sx={{ flex: 1, ml: 1 }}
                                                    />
                                ...
                                <>
                                    <Box sx={{ display: "flex", flexDirection: "column", height: "100%" }}>
                                        {/* Sent Button at Top Left */}
                                        <Box sx={{ textAlign: 'right' }}>
                                            <Button variant="contained" sx={{ backgroundColor: "#FF1B6B" }} onClick={handleOpen}>
                                                Sent
                                            </Button>
                                        </Box>
                                        <List sx={{ width: "100%", bgcolor: "#1A1A1A", borderRadius: 2, mt: 3 }}>
                                            {sentMails.map((mail) => (
                                        ...
                                        {/* Create Mail Button at Bottom */}
                                        <Button onClick={handleCloseMailBox} variant="contained" sx={{ backgroundColor: "#FF1B6B", mt: 3 }} fullWidth>
                                            Create Mail
                                        </Button>
                                    </Box>
                            ...
                            {chatList.length === 0 ? (
                                ...
                                chatList.map((chat: any) => (
                                    ...
                                    >
                                        ...
                                        {/* Chat Info */}
                                        <ListItemText
                                            primary={<Typography sx={{ color: "#FF1B6B", fontWeight: "bold" }}>{chat.Username}</Typography>}
