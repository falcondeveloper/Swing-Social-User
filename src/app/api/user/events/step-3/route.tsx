...
//   subject: string,
//   text: string,
//   recipients: string[] = ["baldhavansh2505@gmail.com"]
// ) {
...
//   const subject = `✅ Event Step-3 Saved — Event ID: ${eventId}`;
//   const body = `
// Event step 3 saved successfully.
...
//     // Update step 3 data
//     const updateQuery = `SELECT * FROM public.event_update_step_3($1, $2, $3, $4)`;
//     const updateValues = [
//       profileId,
//       coverPhoto || null,
...
//     console.log("Executing step-3 query with values:", updateValues);

//     const result = await pool.query(updateQuery, updateValues);

//     if (!result || !result.rows || result.rows.length === 0) {
//       const errorMessage =
//         "Failed to update event step 3 - No event found for this profile or no rows returned";
...
//       message: "Your event step 3 is updated successfully!",
//       status: 200,
//       data: result.rows[0],
//     });
//   } catch (error: any) {
//     console.error("Database query failed for step-3:", error);
