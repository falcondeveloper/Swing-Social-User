...
function parseAuthorizeNetError(errorResponse: any) {
  if (errorResponse?.messages?.message) {
    ...
    const errorMap: { [key: string]: string } = {
      E00003:
        "Invalid card information. Please check your card number, expiry date, and CVV.",
      E00027:
    ...
    return (
      errorMap[code] ||
      "There was an issue processing your payment. Please verify your card details and try again."
    );
  }
      ...
      if (oneTimeResponseData?.transactionResponse?.responseCode === "1") {
        ...
        try {
          ...
          return NextResponse.json({
            success: true,
            message:
              "Payment processed successfully! Your membership has been upgraded.",
