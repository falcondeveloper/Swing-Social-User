...
const BillingUpgrade: any = () => {
	...
	const handleTicketEmail = async (x: any) => {
		...
		console.log(formData, "formData in handleTicketEmail");
	...
	useEffect(() => {
		...
		const storedEventEmailDescription =
			localStorage.getItem("event_edscription");
		...
		if (storedEventEmailDescription)
			setEventEmailDescription(storedEventEmailDescription);
				...
				if(status.message === "0")
				{
					...
					if (response.ok) {
						...
						if (respondCode === "1") {
							...
							console.log("before createTicket", typeof ticketDetailsArray, ticketDetailsArray)
							
							createTicket(ticketDetailsArray);

							console.log("After createTicket", typeof ticketDetailsArray, ticketDetailsArray)
