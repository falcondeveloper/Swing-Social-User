...
import DesktopEventCreateCard from "@/components/DesktopEventCreateCard";
...
const EventForm: React.FC = () => {
  ...
  const uploadImagesSequentially = async (
    ...
    for (const image of images) {
      const result = await uploadEventImage(image);
      console.log(image);
      results.push(result);
    }
    return results;
              ...
              <form onSubmit={handleSubmit}>
                ...
                <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                  <Checkbox
                    ...
                    onChange={(e) =>
                      handleChange("hideVenue", e.target.checked)
                    }
                  />
                  <Box>
                    ...
                    >
                      ...
                      >
                        ...
                        <Box sx={{ textAlign: "center" }}>
                          ...
                          <Typography variant="body2" sx={{ color: "#999" }}>
                            Drag and drop multiple images here, or click to
                            select
                          </Typography>
                          <Typography
                            variant="caption"
