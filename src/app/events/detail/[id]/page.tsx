    ...
    return (
        <Box sx={{ color: "white", padding: "10px" }}>
                    ...
                    <Grid item xs={12} sm={12} lg={12}>
                        ...
                        <Card sx={{ borderRadius: "10px", backgroundColor: "#1d1d1d", marginBottom: 5 }}>
                            <CardContent sx={{
                                            ...
                                            <Grid container sx={{ paddingBottom: 0, justifyContent: 'right' }}>
                                                ...
                                                <Grid item lg={6} md={6} sm={6} xs={6}>
                                                    <Button
                                                        ...
                                                        variant="contained"
                                                        color="primary"
                                                        onClick={() => router.push("/events/update/" + eventDetail.EventId)}
                                                        sx={{
                                                            textTransform: "none",
                                                            backgroundColor: "#f50057",
                                                            py: 1.5,
                                        ...
                                        <TableBody>
                                            <TableRow>
                                                ...
                                                <TableCell sx={{ backgroundColor: "darkgray", width: "70%" }}>
                                                    <Typography color="white">{new Intl.DateTimeFormat('en-US', {
                                            month: 'short',
                                            day: '2-digit',
                                            year: '2-digit',
                                            hour: '2-digit',
                                            // minute: '2-digit',
                                            hour12: true,
                                        }).format(new Date(eventDetail?.StartTime || "2025-01-12T15:00:26.555Z"))}</Typography>
                                                </TableCell>
                                            </TableRow>
                                            <TableRow>
                                                <TableCell
                                            ...
                                            // minute: '2-digit',
                                            hour12: true,
                                        }).format(new Date(eventDetail?.EndTime || "2025-01-12T15:00:26.555Z"))}</Typography>
                                                </TableCell>
                                            </TableRow>
                                            <TableRow>
                                                <TableCell
                                                ...
                                                <TableCell sx={{ backgroundColor: "darkgray", width: "70%" }}>
                                                    <Typography color="white">{eventDetail?.isVenueHidden !== 0 ? "Hidden" : eventDetail?.Venue || "N/A"}</Typography>
                                                </TableCell>
                                            </TableRow>
                                            <TableRow>
                                                <TableCell
                                                ...
                                                <TableCell sx={{ backgroundColor: "darkgray", width: "70%" }}>
                                                    <Typography color="white">
                                                        {eventDetail?.isVenueHidden !== 0 ? "Hidden" : eventDetail?.Venue}
                                                    </Typography>
                                                </TableCell>
                                            </TableRow>
                                            <TableRow>
                                ...
                                <MTicketListComponent tickets={tickets} onTicketsChange={handleTicketsChange} summary={summary} />
                                {/* <Box
                                    sx={{
                                        display: "flex",
                                        flexDirection: "column",
                                ...
                                <RSVPListComponent rsvp={rsvp} loginId={profileId} eventId={id} />

                                <Typography variant="body1" color="white" sx={{ marginTop: 4 }}>
                                    Attendees
                                </Typography>
                                <AttendeesListComponent attendees={attendees} loginId={profileId} eventId={id} />
                            ...
                            <Grid item xs={12} md={8}>
                                ...
                                <Fade in={showContent} timeout={1000}>
                                    <Box sx={{
                                        ...
                                        pb: 4,
                                        textAlign: 'center',
                                        background: 'linear-gradient(45deg, #880E4F 30%, #4A148C 90%)',
                                        borderRadius: '0 0 16px 16px',
                                        mb: 4,
                                        boxShadow: '0 3px 5px 2px rgba(136, 14, 79, .3)',
                                        position: 'relative'
                                    }}>
                                        {profileUsername === eventDetail?.Username ? (<IconButton
                                            sx={{
                                                position: 'absolute',
                                                top: 16,
                                                right: 16,
                                            ...
                                            onClick={() => router.push(`/events/edit?q=${eventDetail?.EventId}`)}
                                        >
                                        ...
                                        <Typography variant="h6" color="white" sx={{ mt: 2, opacity: 0.9 }}>
                                            {new Date(eventDetail?.StartTime).toLocaleString('en-US', {
                                                weekday: 'long',
                                                month: 'long',
                                                day: 'numeric',
                                                hour: 'numeric',
                                    ...
                                    <Card sx={{
                                        ...
                                        <Box sx={{ position: 'relative' }}>
                                            ...
                                            <IconButton
                                                ...
                                                onClick={() => handleReportModalToggle(eventDetail?.UserId)}
                                            >
                                ...
                                {eventDetail?.Images?.length > 0 && (
                                    <Card sx={{ mb: 4, bgcolor: '#1a1a1a', border: "0.0625rem solid rgb(55, 58, 64)", borderRadius: 2, }}>
                                                ...
                                                {eventDetail.Images.map((_: any, index: any) => (
                                                    <Box
                                                        ...
                                                        sx={{
                                                            ...
                                                            height: 8,
                                                            borderRadius: '50%',
                                                            bgcolor: currentImageIndex === index ? '#880E4F' : 'rgba(255,255,255,0.5)',
                                                            cursor: 'pointer',
                                                            transition: 'all 0.3s ease',
                                                            '&:hover': {
                                                                transform: 'scale(1.2)',
                                                                bgcolor: currentImageIndex === index ? '#880E4F' : 'rgba(255,255,255,0.8)'
                                                            }
                                                        }}
                                                    />
                                                ))}
                                ...
                                <Grid sx={{ backgroundColor: '#1a1a1a', px: 4, borderRadius: 2, border: "0.0625rem solid rgb(55, 58, 64)", mb: 5 }} >
                                    <Typography
                                        sx={{ maringLeft: 4, marginTop: 4, marginBottom: 4, color: "#fff", lineHeight: 3 }}
                                        dangerouslySetInnerHTML={{ __html: eventDetail?.Description }}
                                    />
                                </Grid>
                                ...
                                <Grid container spacing={3}>
                                    <Grid item xs={12} md={6}>
                                        <Slide direction="right" in={showContent} timeout={1000}>
                                            <Card sx={{ bgcolor: '#1a1a1a', borderRadius: 2, p: 3, border: "0.0625rem solid rgb(55, 58, 64)" }}>
                                                    ...
                                                    {rsvp?.map((person: any, index: any) => (
                                                        <Avatar
                                                            ...
                                                            onClick={() => {
                                                                ...
                                                                router.push(`/attendeeswing?q=${person.ProfileId}&id=${profileId}&eventid=${id}`);
                                                            }}
                                                            sx={{
                                                                width: 56,
                                                                height: 56,
                                                                ...
                                                                transition: 'all 0.3s ease',
                                                                bgcolor: person.Avatar ? 'transparent' : '#880E4F',
                                                                '&:hover': {
                                                                    transform: 'scale(1.1)',
                            ...
                            <Grid item xs={12} md={4}>
                                <Paper sx={{
                                    ...
                                    <Table sx={{ padding: '0px' }}>
                                        <TableBody>
                                            {[
                                                { icon: <AccessTimeIcon />, label: 'Start Time', value: new Date(eventDetail?.StartTime).toLocaleString() },
                                                { icon: <AccessTimeIcon />, label: 'End Time', value: new Date(eventDetail?.EndTime).toLocaleString() },
                                                { icon: <LocationOnIcon />, label: 'Venue', value: eventDetail?.isVenueHidden !== 0 ? "Hidden" : eventDetail?.Venue },
                                                { icon: <LocationOnIcon />, label: 'Address', value: eventDetail?.isVenueHidden !== 0 ? "Hidden" : eventDetail?.Venue },
                                                { icon: <CategoryIcon />, label: 'Type', value: eventDetail?.Category },
                                                { icon: <PersonIcon />, label: 'Host', value: eventDetail?.Username }
                                            ].map((item, index) => (
                                ...
                                {/* Tickets Section */}
                                {membership === 0 ? <><Alert variant="filled" severity="info">
                                ...
                                <Card sx={{
                                    ...
                                    <CardContent>
                                        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2, px: 4, pt: 2 }}>
                                ...
                                {/* Email Reminder Card */}
                                {loginProfileId !== eventDetail?.OrganizerId ? <><Alert variant="filled" severity="info">
                                ...
                                <Card sx={{
                                    ...
                                    <CardContent sx={{ textAlign: 'center', py: 3 }}>
                                        ...
                                        <Button
                                            variant="contained"
                                            disabled={loginProfileId === eventDetail?.OrganizerId ? false : true}
                                            onClick={handleOpen}
                                            sx={{ bgcolor: '#880E4F', '&:hover': { bgcolor: '#560027' } }}
                                        >
                                            Send Email
                                        </Button>
                                    </CardContent>
                                ...
                                <Card sx={{
                                    ...
                                    <CardContent sx={{ textAlign: 'center', py: 3 }}>
                                        <DownloadIcon sx={{ fontSize: 40, color: '#880E4F', mb: 2 }} />
                                        <Typography variant="h6" color="white" sx={{ mb: 2 }}>
                                            Download Attendees List
                                        </Typography>
                                        <Button
            ...
            <Dialog open={open} onClose={handleCloseHere} maxWidth="sm" fullWidth>
                ...
                >
                    <Button onClick={handleCloseHere} sx={{ background: "white", borderColor: "white", color: "#880E4F" }} variant="outlined">
                        Cancel
                    </Button>
                    <Button
                        ...
                        sx={{ background: "#880E4F", borderColor: "#880E4F", color: "white" }}
                    >
                        Send Email
                    </Button>
                </DialogActions>
            ...
            <Dialog open={openSaveRsvp}>
                ...
                <DialogActions>
                    <Button autoFocus onClick={() => { setOpenSaveRsvp(!openSaveRsvp); }} sx={{ color: 'red' }}>
                        Ok
                    </Button>
                </DialogActions>
            </Dialog>
