          ...
          >
            ...
            <IconButton
              ...
              onClick={() =>
                onQuantityChange(
                  ticket.name,
                  ticket.quantity > 0 ? ticket.quantity - 1 : 0
                )
              }
            >
              <Box
...
const TicketPackages: React.FC<TicketPackagesProps> = ({
  initialTickets,
  onTicketsUpdate,
}) => {
  ...
  const handleGetEventDetail = async (eventId: any) => {
    try {
      ...
      setFormData({
        ...
        tags: [],
        allowFreeUsers: false,
        hideVenue: eventData?.event?.isVenueHidden == 1 ? true : false,
        hideTicketOption: eventData?.event?.HideTicketOption,
      });
    } catch (error) {
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Editor
              ...
              onEditorChange={(content) =>
                handleChange("emailDescription", content)
              }
              init={{
                menubar: false,
                statusbar: false,
                  ...
                  >
                    ...
                    >
                      ...
                      <FormControlLabel
                        control={
                          <Checkbox
                            checked={formData.hideTicketOption}
                            onChange={(e) =>
                              handleChange(
                                "hideTicketOption",
                                e.target.checked === true ? 1 : 0
                      ...
                      <Box>
                        ...
                        >
                          Enter the description of the email sent to the
                          attendees
                        </Typography>
                        <Paper
                          elevation={2}
                      ...
                      <FormControlLabel
                        ...
                        label={
                          ...
                          >
                            ...
                            <Tooltip
                              title="Enable this to make the event accessible to free users"
                              arrow
                            >
                              <InfoIcon
                                sx={{
