...
import { Send as SendIcon, EmojiEmotions as EmojiIcon, Image as ImageIcon, Delete, ArrowBack, Close } from "@mui/icons-material";
...
export default function ChatPage() {
    ...
    const fetchAllChats = async () => {
        try {
            ...
            const response = await axios.get(`/api/user/mailbox?profileid=${profileid}&type=sent`);
                        ...
                        <Box sx={{ 
                            ...
                            <List>
                                ...
                                {chatList.map((chat: any, index: number) => {
                                    if(chat.Subject === "Friend Request"){
                                        return null;
                                    }
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <ListItemText
                                                ...
                                                primary={<span>{chat.ProfileToUsername}</span>}
                    ...
                    <Box sx={{ display: "flex", flex: 1 }}>
                        ...
                        <Box
                            sx={{
                                ...
                                scrollBehavior: 'smooth',   // Stack children vertically
                                "&::-webkit-scrollbar": {
                                    width: "8px",
                                },
                                "&::-webkit-scrollbar-track": {
                        ...
                        >
                            {selectedMail ? (
                                ...
                                {selectedMail?.subject === "Friend Request" ? null :
                                    (
                                        ...
                                        >
                                            ...
                                            <Avatar
                                                ...
                                                alt={mail?.ProfileToUsername || "User"}
                                                src={mail?.Avatar2 || "/noavatar.png"}
                                                onClick={() => {
                                                    setShowDetail(true);
                        ...
                        <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 2 }}>
                            ...
                            <Button 
                                ...
                                onClick={async () => {
                                    try {
                                        const response = await fetch(
                                            `/api/user/sweeping?page=1&size=50&search=${encodeURIComponent(searchQuery)}`
                                        );
                                        const data = await response.json();
                                        if (data?.profiles?.length > 0) {
