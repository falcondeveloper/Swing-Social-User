...
const ProfileCard: React.FC<ProfileCardProps> = ({ user, onProfileClick, onReport }) => {
                    ...
                    <Grid item xs={6} sm={7}>
                        <Box sx={{ pl: { xs: 1, sm: 2 } }}>
                            ...
                            >
                                ...
                                {user?.PartnerDateOfBirth && (
                                    <>
                                        ...
                                        {user?.PartnerGender === "Male" ? "M" : user?.PartnerGender === "Female" ? "F" : ""}
                                    </>
                                )}
                            </Typography>
                            ...
                            >
                                ...
                                >
                                    <LocationOnIcon sx={{ fontSize: { xs: '0.9rem', sm: '1rem' } }} />
...
export default function Pineapple() {
    ...
    const [profileId, setProfileId] = useState<string>("7c4cabe7-f7d2-4577-a9c2-de8b9c2af2c7");
