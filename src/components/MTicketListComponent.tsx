...
type TicketListProps = {
    tickets: Ticket[];
    onTicketsChange: (quantity: number, price: number, name?: string, type?: string) => void;
    summary: any;
};
                    ...
                    {tickets.map((ticket, index) => (
                        <Fade key={ticket.TicketPackageId} in={true} timeout={500} style={{ transitionDelay: `${index * 100}ms` }}>
                            ...
                            >
                                ...
                                >
                                    <Button variant="contained" sx={{ bgcolor: "#420b8f", '&:hover': { bgcolor: "#35077a" } }}>
                                        {ticket.Type.toUpperCase()}
                                    </Button>
                                    <Button variant="contained" sx={{ bgcolor: "#880E4F", '&:hover': { bgcolor: "#560027" } }}>
                                        ${ticket.Price}
                                    </Button>
                                </Box>
