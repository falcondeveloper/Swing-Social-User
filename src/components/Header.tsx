						...
						<Box sx={{ height: "100vh", display: "flex", flexDirection: "column" }}>
							...
							<Box sx={{ p: 3, borderBottom: "1px solid rgba(255, 255, 255, 0.05)" }}>
								<Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", mb: 2 }}>
									<Typography variant="h6" sx={{ color: "#FF1B6B", fontWeight: 600 }}>
										SwingSocial
									</Typography>
									<IconButton
										...
										return (
											<ListItem
												...
												sx={{
													...
													mb: 1,
													cursor: "pointer",
													backgroundColor: isActive ? "rgba(255, 27, 107, 0.1)" : "transparent",
													border: isActive ? "1px solid rgba(255, 27, 107, 0.2)" : "1px solid transparent",
													transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",
													"&:hover": {
										...
										<Box key={item.label} sx={{ position: "relative" }}>
											...
											<Button
												...
												sx={{
													...
													fontSize: "15px",
													position: "relative",
													background: isActive ? "rgba(255, 27, 107, 0.1)" : "transparent",
													"&:hover": {
														color: "#FF1B6B",
						...
						<Box sx={{ display: "flex", gap: 3, alignItems: "center" }}>
							...
							<Box
								sx={{
									...
									background: "linear-gradient(135deg, rgba(255, 27, 107, 0.1), rgba(194, 24, 91, 0.1))",
									overflow: "hidden",
									cursor: "pointer",
									position: "relative",
